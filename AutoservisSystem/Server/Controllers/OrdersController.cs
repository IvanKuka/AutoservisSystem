    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Order>>> GetOrders()
        {
            return await _context.Orders
                .Include(o => o.Tasks)
                .Include(o => o.OrdersParts).OrderBy(o => o.ReceivedDate)
                .ToListAsync();
        }

        [HttpGet("notDone")]
        public async Task<ActionResult<IEnumerable<Order>>> GetNotDoneOrders()
        {
            var tmp = await _context.Orders.Where(o => o.Done == false)
                .Include(o => o.Tasks)
                .Include(o => o.OrdersParts).ToListAsync();
            return tmp;
        }
        ...
        {
            return await _context.Orders.Where(o => o.Done == true)
                .Include(o => o.Tasks)
                .Include(o => o.OrdersParts).ToListAsync();
        }
        ...
        public async Task<ActionResult<Order>> GetOrder(int id)
        {
            var order = await _context.Orders.Where(o => o.OrderId == id)
                .Include(o => o.Tasks)
                .Include(o => o.OrdersParts).FirstAsync();
